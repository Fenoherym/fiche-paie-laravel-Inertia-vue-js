                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-md-9">
                                        <input type="date" id="month" class="form-control" aria-describedby="passwordHelpInline" v-model="personnel.hiring_date">
                                    </div>
                                </div>
                                <div class="row g-3 align-items-center">
                                    <div class="col-3 text-end mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" id="month" class="form-control" aria-describedby="passwordHelpInline" v-model="personnel.base_salary">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <hr>
                            <div class="row simulation-btn" v-if="simulingActive">
                                <button class="btn btn-primary text-center" @click="simuling"><i class="fa-solid fa-spinner me-3"></i> Simuler</button>
                            </div>
                        <hr>
                        <div class="row" v-if="Object.keys(this.personnel).length !== 0 && isSimuling">
                            ...
                            <div class="row">
                                <div class="card mb-5" style="box-shadow:none">
                                    <p>Salaire brute: {{ total_gain_brut - total_brute_salarial }}</p>
                                    <p>Salaire brute imposable: {{ total_gain_brut - total_brute_salarial - valeur_irsa }}</p>
                                    <p>Net à payer: {{ gain_total - retenue_salarial_total }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="row save-btn">
                            <button v-if="simulingActive && isSimuling" class="btn btn-primary text-center" @click="storeBulletin()"><i class="fa fa-save me-3"></i> Enregistrer</button>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    layout: MainLayout,
    props: ['personnels', 'rubriques', 'irsas', "errors"],
    components:{
        AddIndemnity,
        Link
    },
    ...
    methods:{
        ...
        getNombreAbsence(event){
           ...
           if(Object.keys(this.personnel).length !== 0){
        ...
        activeSimuling(){
            if(this.debut_periode !== null && this.fin_periode !==null && this.mois !== null && Object.keys(this.personnel).length !== 0){
        ...
        calculGainBrut(rubrique){
            if(!rubrique.isRetenue){
                if(rubrique.nombre != null){
                    ...
                    if(rubrique.taux_part_salarial === null || rubrique.taux_part_salarial===0){
                        return (rubrique.base).toFixed(2)
                    }else{
                        return (( rubrique.base * rubrique.taux_part_salarial)/100).toFixed(2)
                    }
                }
            }else{
                return 0
